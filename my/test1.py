...
BATCH_SIZE = 3  
CAPACITY = 2000  
MAX_STEP = 6 # with current parameters, it is suggested to use MAX_STEP>10k  
...
def run_training():  
    ...
    train_dir = 'D:/tensorflow/mydata/cat_dog/'   #My dir--20170727-csq  
    #logs_train_dir = '/home/kevin/tensorflow/cats_vs_dogs/logs/train/'  
    logs_train_dir = 'D:/tensorflow/mylog/cat_dog/'  
...
def evaluate_one_image():  
    ...
    # you need to change the directories to yours.  
    #train_dir = '/home/kevin/tensorflow/cats_vs_dogs/data/train/'  
    train_dir = 'D:/tensorflow/mydata/cat_dog/cat.9.jpg'  
    #train, train_label = input_data.get_files(train_dir)  
